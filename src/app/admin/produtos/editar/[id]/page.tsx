...
export default function EditarProdutoPage() {
  ...
  if (isLoading) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-[#fbf6f1] px-4 pb-12 pt-32 text-[#1c1418] sm:px-6 sm:pb-20">
        <div className="text-center">
            <div className="mx-auto mb-4 h-16 w-16 animate-spin rounded-full border-4 border-copper border-t-transparent"></div>
            <p className="text-[#7b665d]">Carregando produto...</p>
        </div>
      </div>
    );
  }
  ...
  return (
      ...
      <div className="flex items-center space-x-4 mb-8 sm:mb-12">
          ...
          <h1 className="font-serif text-3xl text-[#1c1418] sm:text-4xl">Editar Produto</h1>
      </div>
          ...
          <div className="space-y-6 rounded-3xl border border-[#eadfd4] bg-white p-6 shadow-[0_20px_50px_rgba(48,20,31,0.05)] sm:p-10">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="lg:col-span-3">
                <label className="text-[9px] block mb-4 font-bold uppercase tracking-widest text-[#8b7c72]">Notas Olfativas *</label>
