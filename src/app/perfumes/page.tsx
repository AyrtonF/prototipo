    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-background px-6 text-center text-foreground">
        <div>
          ...
          <p className="mt-4 text-sm text-muted">Cadastre perfumes no painel administrativo para exibir esta coleção.</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-background px-4 pb-16 pt-8 text-foreground sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        <div className="mb-5 text-sm text-muted">
          ...
          <Link href="/perfumes" aria-current="page" className="text-foreground transition-colors hover:text-copper">
            Perfumes
          </Link>
        </div>
        ...
        <div className="flex flex-col gap-8 lg:flex-row lg:gap-10">
          ...
          <aside className={`${showFilters ? "block" : "hidden"} lg:block w-full lg:w-62.5 lg:shrink-0`}>
            <div className="sticky top-24 rounded-[1.75rem] border border-border bg-surface p-6 shadow-[0_18px_50px_rgba(48,20,31,0.06)] sm:p-7">
              ...
              <div className="space-y-8">
                ...
                <div>
                  <span className="mb-4 block text-[9px] font-bold uppercase tracking-widest text-muted">Intensidade</span>
                ...
                <div>
                  <span className="mb-4 block text-[9px] font-bold uppercase tracking-widest text-muted">Nota Principal</span>
                  <div className="relative">
                    <select
                      className="w-full appearance-none rounded-xl border border-transparent bg-copper px-4 py-3 text-sm font-medium text-cream outline-none transition-all focus:ring-2 focus:ring-[#e8c7b9]/60"
                      value={note}
                    ...
                    <ChevronRight className="pointer-events-none absolute right-3 top-1/2 -translate-y-1/2 rotate-90 text-cream" size={18} />
                  </div>
                </div>
          ...
          <div className="min-w-0 flex-1">
            {filteredPerfumes.length === 0 ? (
                ...
                <h3 className="mb-3 font-serif text-2xl text-foreground">Nenhum perfume encontrado</h3>
